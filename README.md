...
1. Иметь возможность быстро создавать (а также удалять) виртуальные машины и сети для выполнения дальнейших шагов дипломной работы с целью экономии денег на счету в YandexCloud.
